...
from test.test_jwt_auth import TestJWTAuth
...
class TestViewSetBase(APITestCase):
    ...
    def login(self, is_staff: bool = True):
        response = self.jwt.token_request(is_staff=is_staff)
    ...
    def delete_by_id(self, args: List[Union[str, int]] = None) -> bool:
